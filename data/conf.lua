function love.conf(t)
    ...
    t.window.title = "Sonny 2 Port"     -- The window title (string)
    ...
    t.window.minwidth = 1000               -- Minimum window width if the window is resizable (number)
    t.window.minheight = 1000              -- Minimum window height if the window is resizable (number)
