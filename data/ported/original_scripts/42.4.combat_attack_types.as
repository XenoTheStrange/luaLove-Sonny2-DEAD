...
function krinMelee(shooter, hitter, attackColor, attackType, boomType)
{
...
function krinBoltMake(shooter, hitter, tColorKrin, projectileModel, boomType)
{
   _root.boltMakerCounter++;
